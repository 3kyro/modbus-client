...
var $author$project$View$Connect$viewConnectMenu = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('connect_menu_extension'),
				$elm$html$Html$Attributes$class('menu_bar_extension')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$View$viewEmptyMenu = $elm$html$Html$text('');
...
var $author$project$View$viewModType = function (value) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('modType')
			]),
		function () {
			if (value.$ === 'ModWord') {
				return _List_fromArray(
				...
				return _List_fromArray(
					[
						$elm$html$Html$text('Float')
					]);
			}
		}());
};
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$View$viewModValue = function (value) {
	return A2(
		$elm$html$Html$label,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('modValue')
			]),
		function () {
			_v0$2:
			while (true) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('regTable')
					]),
				_List_fromArray(
					[
						A2(
